  ...
  return (
    <main className="p-6 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Link href="/leads/create" className="px-3 py-2 rounded bg-blue-600 text-white hover:bg-blue-700">
          Create Lead
        </Link>
      </div>
      ...
      {data && (
        <ul className="space-y-2">
          {data.map((l) => (
            <li key={l.id} className="p-3 rounded border bg-white flex items-center justify-between">
              <div>
