          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setScanParams(prev => ({ ...prev, geographic_scope: e.target.value }))}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-600">
                  Started: {runs[currentRun]?.created_at ? new Date(runs[currentRun].created_at).toLocaleString() : "N/A"}
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{latestReport.trends_analyzed}</div>
                <div className="text-sm text-gray-600">Trends Analyzed</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">{latestReport.gaps_identified}</div>
          </div>
    </div>
  );
}
